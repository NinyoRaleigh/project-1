...
<template>
    <div
        class="basis-1/2 absolute right-3/22 bottom-1/9 border border-black rounded-lg w-4/9 h-25 flex justify-evenly items-center bg-orange-200">
        ...
        <div class="flex flex-col items-center">
            <svg class="w-10 h-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 54 33">
        ...
        <div class="flex flex-col items-center">
            <svg class="w-10 h-10" viewBox="0 0 256 256" width="256" height="256" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex flex-col items-center">
            <svg class="w-10 h-10" viewBox="0 0 256 221" width="256" height="221" xmlns="http://www.w3.org/2000/svg"
                preserveAspectRatio="xMidYMid">
